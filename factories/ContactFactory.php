...
{
        public static function getFirstContact($customConfig = NULL)
    {
        $client = GoogleHelper::getClient($customConfig);

        $req = new \Google_Http_Request('https://www.google.com/m8/feeds/contacts/default/full?max-results=1&updated-min=2007-03-16T00:00:00');
